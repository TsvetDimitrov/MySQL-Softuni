CREATE TABLE `carrentaldb`.`categories`(
...
INSERT INTO `carrentaldb`.`categories`(`id`,`category`, `daily_rate`, `weekly_rate`, `monthly_rate`, `weekend_rate`)
VALUES
('1','Coupe',5, 20, 40, 12), 
('2','Sedan',4, 25, 60, 11), 
('3','Camper',7, 40, 100, 18);

CREATE TABLE `carrentaldb`.`cars`(
`id` INT PRIMARY KEY NOT NULL AUTO_INCREMENT,
...
INSERT INTO `carrentaldb`.`cars`(`id`,`plate_number`, `make`, `model`, `car_year`, `category_id`, `doors`, `picture`, `car_condition`, `available`)
VALUES
...
CREATE TABLE `carrentaldb`.`employees`(
`id` INT PRIMARY KEY NOT NULL AUTO_INCREMENT,
...
INSERT INTO `carrentaldb`.`employees`(`id`,`first_name`, `last_name`, `title`, `notes`)
VALUES
...
CREATE TABLE `carrentaldb`.`customers`(
`id` INT PRIMARY KEY NOT NULL AUTO_INCREMENT,
...
INSERT INTO `carrentaldb`.`customers`(`id`,`driver_licence_number`, `full_name`, `address`, `city`, `zip_code`, `notes`)
VALUES
...
CREATE TABLE `carrentaldb`.`rental_orders`(
`id` INT PRIMARY KEY NOT NULL AUTO_INCREMENT,
...
INSERT INTO `carrentaldb`.`rental_orders`(`id`,`employee_id`, `customer_id`, `car_id`, `car_condition`, `tank_level`, `kilometrage_start`,
